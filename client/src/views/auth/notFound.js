        ...
        <main class="flex min-h-screen items-center justify-center px-6 py-10">
            <section class="w-full max-w-2xl rounded-[2rem] border border-blue-100 bg-white p-10 text-center shadow-xl shadow-blue-100/70">
                ...
                <div class="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
                    <button id='btn-back' class="cursor-pointer inline-flex items-center justify-center rounded-2xl bg-blue-600 px-5 py-3 text-sm font-bold text-white hover:bg-blue-500">Aceptar</button>
                </div>
            </section>
        </main>
    `
