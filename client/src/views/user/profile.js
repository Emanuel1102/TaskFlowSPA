                ...
                <section class="rounded-[2rem] border border-blue-100 bg-white p-8 shadow-xl shadow-blue-50">
                    <form class="grid gap-5">
                        ...
                        <div class="flex flex-col gap-3 pt-2 sm:flex-row">
                            <button class="cursor-pointer inline-flex items-center justify-center rounded-2xl bg-blue-600 px-5 py-3 text-sm font-bold text-white hover:bg-blue-500" href="/src/views/profile.html">Guardar cambios</button>
                            <button id="cancel-btn" type="reset" class="cursor-pointer inline-flex items-center justify-center rounded-2xl bg-blue-600 px-5 py-3 text-sm font-bold text-white hover:bg-blue-500" href="/src/views/profile.html">Cancelar</button>
                            <button id='delete-account-btn' class="cursor-pointer inline-flex items-center justify-center rounded-2xl border border-blue-200 bg-white px-5 py-3 text-sm font-bold text-blue-700 hover:bg-blue-50">Eliminar mi cuenta</button>
                        </div>
                    </form>
                </section>
            </section>
